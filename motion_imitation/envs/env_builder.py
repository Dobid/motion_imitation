...
def build_imitation_env(motion_files, num_parallel_envs, mode,
  ...
  sensors = [
      ...
      sensor_wrappers.HistoricSensorWrapper(wrapped_sensor=robot_sensors.IMUSensor(['R', 'P', 'Y', 'dR', 'dP', 'dY']), num_history=3), # added yaw and dYaw in obs
      # sensor_wrappers.HistoricSensorWrapper(wrapped_sensor=robot_sensors.IMUSensor(), num_history=3), # obs without yaw and dyaw
