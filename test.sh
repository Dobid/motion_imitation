...
python3 motion_imitation/run.py --mode test --motion_file motion_imitation/data/motions/data_train_4.txt --model_file ../model_saves/custom_ref_2.zip --visualize --sync_reference
