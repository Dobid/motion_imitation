...
python3 motion_imitation/run.py --mode test --motion_file motion_imitation/data/motions/data_train_7.txt --model_file model_saves/custom_ref_7.zip --visualize --sync_reference
